...
Настоящая политика обработки персональных данных составлена в соответствии с требованиями Федерального закона от 27.07.2006. №152-ФЗ «О персональных данных» и определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных данных сервиса Superhub Hosting (далее – Оператор).
...
**1\.** Цель обработки персональных данных Пользователя — информирование Пользователя посредством отправки электронных писем; предоставление доступа Пользователю к сервисам, информации и/или материалам, содержащимся на веб-сайте; связь с Пользователем по указанным контактам; идентификация Пользователя; обеспечение безопасности аккаунта Пользователя; оказание услуг Пользователю.
...
*Последняя редакция: 10 октября 2025 года*
