...
2. Перейди в раздел **«Настройки»** ➜ **Управление файлами** ➜ файл `server.properties`.
...
Стандартный способ через настройки сервера имеет минусы, для решения которых используют плагин **ForceResourcePacks** (или аналоги, например, *WorldResourcePacks*).
