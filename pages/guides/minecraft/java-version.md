...
Наш хостинг предоставляет диапазон версий Java на выбор — начиная с Java 8, заканчивая Java 21. Все эти версии требуются для разных версий самой игры Minecraft, и игра может не работать с определёнными версиями.
