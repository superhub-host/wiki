...
Для гибкой настройки используется система permissions через специальные плагины. В нашем случае это LuckPerms.
...
Чтобы открыть веб-редактор, встроенный в LuckPerms, введите команду `/lp editor`. После этого в чате выведется ссылка на панель управления правами на вашем сервере.
...
Группы могут наследовать права друг друга.

Например:

+ moderator наследует default;
+ admin наследует moderator.

Это позволяет выстраивать логичную структуру прав без дублирования настроек.
