...
Если обычный игрок попытается вскопать землю внутри этой зоны, со стороны это будет выглядеть так: блок ломается, а затем мгновенно появляется обратно.
...
### Ожидание, что spawn-protection заменит приваты

Встроенная функция защищает только один небольшой квадрат вокруг мирового спавна. Для защиты домов игроков, городов и других построек всё равно нужны полноценные плагины на регионы.
