...
Преимущество такой системы в том, что если игрок решит поменять свой никнейм, сервер продолжит его узнавать, и все данные останутся на месте. UUID при этом не меняется.
