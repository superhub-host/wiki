...
![exit code: <код>](/images/guides/hosting/server-errors/exit_code.png)
...
![exit code: 1 - Unable to access jarfile](/images/guides/hosting/server-errors/jarfile_error.png)
...
![ошибка команды запуска](/images/guides/hosting/server-errors/JVM_error.png)
