...
Мы рекомендуем всем клиентам, использующим ядро Spigot или любое другое (этот способ не распространяется на версии игры на телефоне, Minecraft PE), использовать [SRV-запись](/guides/minecraft/configure-domain) на своих серверах. Это решит проблему подключения к серверу по IP-адресу.
